...
export default {
    ...
    mounted()
    {
        Object.getOwnPropertyNames(BODY_PART)
            .filter( (part) => !part.startsWith('_'))
            .forEach( (part) => this.updateHealthColor(BODY_PART[part], this.$props[BODY_PART[part]]) );
    },
    methods:
    {
