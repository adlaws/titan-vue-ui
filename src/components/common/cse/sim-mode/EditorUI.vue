...
import MapOverlay from '@/components/common/cse/sim-mode/MapOverlay.vue';
import DrawingTools from '@/components/common/cse/sim-mode/DrawingTools.vue';
import WorldState from '@/components/common/cse/sim-mode/WorldState.vue';
import CseScenarioObjects from '@/components/common/cse/core/activeobjects/CseScenarioObjects.vue';
import WaypointSettings from '@/components/common/cse/core/waypointsettings/WaypointSettings.vue';
import AarStatistics from '@/components/common/cse/core/aarstatistics/AarStatistics.vue';
import EntitySpotlight from '@/components/common/cse/core/entityspotlight/EntitySpotlight.vue';
