...
import TitanInput from '@/components/common/cse/forms/fields/basic/TitanInput.vue';
...
export default {
    ...
    computed: {
        ...
        getValue()
        {
            let result = parseInt(this.strValue, 10);
            return isNaN(result)?null:result;
        },
        minValue()
        {
            let result = parseInt(this.min, 10);
            return isNaN(result)?null:result;
        },
        maxValue()
        {
            let result = parseInt(this.max, 10);
            return isNaN(result)?null:result;
        },
        errorText()
        {
